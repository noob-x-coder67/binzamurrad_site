  ...
  const projects = [
    {
      ...
      description: "A modern e-commerce platform with real-time inventory management and secure payment integration.",
    ...
    },
    {
      ...
      description: "Comprehensive dashboard for managing patient records, appointments, and medical data.",
    ...
    },
    {
      ...
      description: "Beautiful and intuitive mobile app design for a premium restaurant chain.",
    ...
    },
    {
      ...
      description: "Dynamic promotional video for a tech startup's product launch campaign.",
    ...
    },
    {
      ...
      description: "Comprehensive digital marketing campaign that increased engagement by 300%.",
    ...
    },
    {
      ...
      description: "Modern property listing website with advanced search and virtual tour features.",
    ...
    },
    {
      ...
      description: "Clean and motivating UI design for a fitness tracking mobile application.",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Explore our recent projects and see how we've helped clients achieve their digital goals.
            </p>
          </div>
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl mb-3 text-white" style={{ fontFamily: 'Poppins, sans-serif' }}>
                    {project.title}
                  </h3>
